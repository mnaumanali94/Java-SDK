...
public class ErrorCodesController extends BaseController {    
     ...
     * @return The singleton instance of the ErrorCodesController class 
     */
    public static ErrorCodesController getInstance() {
    ...
    public void get400Async(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5325923432663227939L;
            {
     ...
     * @return    Returns the DynamicResponse response from the API call 
     */
    public DynamicResponse get500(
    ) throws Throwable {
        APICallBackCatcher<DynamicResponse> callback = new APICallBackCatcher<DynamicResponse>();
        get500Async(callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void get500Async(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4890442273817524628L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
